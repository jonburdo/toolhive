...
func (rr *RegistryRoutes) getCurrentProvider(w http.ResponseWriter) (regprovider.Provider, bool) {
	provider, err := regprovider.GetDefaultProviderWithConfig(rr.configProvider)
	if err != nil {
...
func (rr *RegistryRoutes) updateRegistry(w http.ResponseWriter, r *http.Request) {
	...
	regprovider.ResetDefaultProvider()
